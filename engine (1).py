...
# Validated categorical palette (dataviz skill, fixed slot order -- do not
# reorder; the order is what keeps adjacent pairs colorblind-safe).
ASSET_COLORS = {
    "SPY": "#2a78d6",   # slot 1 blue
    "XLE": "#eb6834",   # slot 2 orange -- reads naturally as "energy/oil"
    "EEM": "#1baf7a",   # slot 3 aqua
    "GLD": "#eda100",   # slot 4 yellow -- reads naturally as "gold"
    "TLT": "#e87ba4",   # slot 5 magenta
    "UUP": "#008300",   # slot 6 green -- reads naturally as "dollar"
}
BENCHMARK_COLOR = "#898781"   # muted ink -- the "boring" 100%-SPY baseline
EQUAL_WEIGHT_COLOR = "#4a3aa7"  # slot 7 violet
